...
<a title="Liste des utilisateurs" href="affichage.php" rel="external" data-icon="grid" data-iconpos="notext" data-direction="reverse" class="ui-btn-right-bis jqm-home ui-btn  ui-btn-icon-notext ui-btn-corner-all"><span class="ui-icon  ui-icon-grid"></span></a>
	...
	<h1>Les ventes: Liste des commandes</h1>
...
<div data-role="navbar">
		<ul>
			...
			<li><a href="vente.php">Vente Confirmer</a></li>
			<li><a href="progress.php">A facture</a></li>
		</ul>
	</div>
<?php
 ...
 if($total) {
    echo '<table data-role="table" id="movie-table" data-mode="reflow" class="ui-responsive table-stroke">'."\n";
            echo '<thead>';
            echo '<tr>';
            echo '<th data-priority="1"><h5><FONT face="Agency FB">Num</font></th>';
			echo '<th data-priority="2"><h5><FONT face="Agency FB">Nom</font></th>';
			echo '<th data-priority="1"><h5><FONT face="Agency FB">Hors tax</font></th>';
			echo '<th data-priority="1"><h5><FONT face="Agency FB">Total</font></th>';
			echo '<th data-priority="2"><h5><FONT face="Agency FB">Etat</font></th>';
			echo '<th data-priority="2"><h5><FONT face="Agency FB">Date confirm</font></th>';
            echo '</tr>'."\n";
			echo '</thead>';
			echo '<tbody>';
  while ($row = pg_fetch_array($result)) {
				...
				echo '<td bgcolor="#dddddd">'.$row["date_confirm"].'</td>';
