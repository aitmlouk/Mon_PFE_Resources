...
<?php
 ...
 $dbh = pg_connect("host=localhost dbname=$base user=openpg password=openpgpwd");
     ...
     // execute query
     $sql = "SELECT * FROM sale_order where name='".$_POST[name]."'";
...
<div data-role="header" data-theme="b">
<a title="Ajout" href="affichage.php" rel="external" data-icon="back" data-iconpos="notext" data-direction="reverse" class="ui-btn-right-bis jqm-home ui-btn  ui-btn-icon-notext ui-btn-corner-all"><span class="ui-icon  ui-icon-back"></span></a>
