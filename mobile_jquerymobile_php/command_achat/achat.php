...
<div data-role="navbar">
		<ul>
			...
			<li><a href="progress.php">Facturé</a></li>
		</ul>
	</div>
<?php
 ...
 // execute query
 $sql = "SELECT * FROM purchase_order where state='approved'";
