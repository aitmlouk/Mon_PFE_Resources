...
<?php
 ...
 if($total) {
    echo '<table data-role="table" id="movie-table" data-mode="reflow" class="ui-responsive table-stroke">'."\n";
			...
			echo '<th data-priority="2"><FONT face="Agency FB">Nom</font></th>';
			echo '<th data-priority="1"><FONT face="Agency FB">Actif</font></th>';
			echo '<th data-priority="2"><FONT face="Agency FB">Fournisseur</font></th>';
			echo '<th data-priority="2"><FONT face="Agency FB">Client</font></th>';
            echo '</tr>'."\n";
			echo '</thead>';
			echo '<tbody>';
