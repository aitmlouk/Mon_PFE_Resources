...
<select data-role='slider' name='active_updated'>
 ...
 <label class='ui-input-text' ><FONT face='Verdana, Geneva, sans-serif'>Fournisseur:</fotn></label>
...
if (isset($_POST['new']))  
{  
$result = pg_query($db, "DELETE FROM res_partner where id='".$_POST[id_updated]."'");  
if (!$result)  
{  
echo "delete failed!!";  
}  
