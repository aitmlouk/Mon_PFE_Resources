...
<input type='text' name='street_updated' value='$row[street]' />
  <label class='ui-input-text' ><FONT face='Verdana, Geneva, sans-serif'>Paye:</font></label>  
...
<input type='date' name='date_updated' value='$row[date]' />
...
$result = pg_query($db, "UPDATE res_partner SET name = '".$_POST[name_updated]."', company_id = '".$_POST[company_updated]."', active='".$_POST[active_updated]."',supplier='".$_POST[supplier_updated]."', customer='".$_POST[customer_updated]."', street='".$_POST[street_updated]."', city='".$_POST[city_updated]."', zip='".$_POST[zip_updated]."', function='".$_POST[function_updated]."', mobile='".$_POST[mobile_updated]."', fax='".$_POST[fax_updated]."', email='".$_POST[email_updated]."', notification_email_send='".$_POST[notification_email_send_updated]."', website='".$_POST[website_updated]."', date='".$_POST[date_updated]."' where id='".$_POST[id_updated]."'");  
if (!$result)  
{  
echo "Update failed!!";  
}  
