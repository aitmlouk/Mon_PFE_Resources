...
<label class='ui-input-text' ><FONT face='Verdana, Geneva, sans-serif'>Unite de mesure vente coeff:</font></label>
...
<label class='ui-input-text' ><FONT face='Verdana, Geneva, sans-serif'>Method vente:</font></label>
<input type='text' name='cost_updated' value='$row[cost_method]' />
<label class='ui-input-text' ><FONT face='Verdana, Geneva, sans-serif'>Deali vente:</font></label>
<input type='text' name='sale_updated' value='$row[sale_delay]' />  
<label class='ui-input-text' ><FONT face='Verdana, Geneva, sans-serif'>Method de fourniture:</font></label>
<input type='text' name='supply_updated' value='$row[supply_method]' />  
<label class='ui-input-text' >Method procurer:</font></label>
...
if (isset($_POST['new']))  
{  
$result = pg_query($db, "DELETE FROM product_template where id='".$_POST[id_updated]."'");  
if (!$result)  
{  
echo "delete failed!!";  
}  
