...
<?php
 ...
 if($total) {
    echo '<table data-role="table" id="movie-table" data-mode="reflow" class="ui-responsive table-stroke">'."\n";
            echo '<thead>';
            echo '<tr>';
            echo '<th data-priority="1"><FONT face="Agency FB">Num</font></th>';
			echo '<th data-priority="2"><FONT face="Agency FB">Login</font></th>';
			echo '<th data-priority="1"><FONT face="Agency FB">Mot passe</font></th>';
			echo '<th data-priority="1"><FONT face="Agency FB">Partenaire</font></th>';
			echo '<th data-priority="1"><FONT face="Agency FB">Actif</font></th>';
			echo '<th data-priority="2"><FONT face="Agency FB">Date login</font></th>';
            echo '</tr>'."\n";
			echo '</thead>';
			echo '<tbody>';
  while ($row = pg_fetch_array($result)) {
				...
				echo '<td bgcolor="#dddddd">'.$row["login"].'</td>';
				echo '<td bgcolor="#dddddd">'.$row["password"].'</td>';
				echo '<td bgcolor="#dddddd">'.$row["partner_id"].'</td>';
                echo '<td bgcolor="#dddddd">'.$row["active"].'</td>';
				echo '<td bgcolor="#dddddd">'.$row["login_date"].'</td>';
...
<a title="Acceile" href="insert.php" rel="external" data-icon="plus" data-iconpos="notext" data-direction="reverse" class="ui-btn-right-bis jqm-home ui-btn  ui-btn-icon-notext ui-btn-corner-all"><span class="ui-icon  ui-icon-plus"></span></a>
	...
	<h1><FONT face="Agency FB">&copy; 2013</FONT></h1>
