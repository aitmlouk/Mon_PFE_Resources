...
<input class='ui-input-text ui-body-null ui-corner-all ui-shadow-inset ui-body-c' name='partner_updated'  value='$row[partner_id]' type='text'>
<label class='ui-input-text' ><FONT face='Verdana, Geneva, sans-serif'>Menu Num:</font></label>
...
<label class='ui-input-text' > <FONT face='Verdana, Geneva, sans-serif'>Alias Num:</label>
<input class='ui-input-text ui-body-null ui-corner-all ui-shadow-inset ui-body-c' name='alias_updated' value='$row[alias_id]' type='text'>
...
if (isset($_POST['new']))  
{  
$result = pg_query($db, "UPDATE res_users SET login = '".$_POST[login_updated]."', password = '".$_POST[password_updated]."', company_id='".$_POST[company_updated]."',partner_id='".$_POST[partner_updated]."', menu_id='".$_POST[menu_updated]."', alias_id='".$_POST[alias_updated]."', active='".$_POST[active_updated]."' where id='".$_POST[id_updated]."'");  
if (!$result)  
{  
echo "Update failed!!";  
}  
